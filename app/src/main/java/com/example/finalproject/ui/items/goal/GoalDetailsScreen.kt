...
object GoalDetailsDestination : NavigationDestination {
    override val route = "goal_details"
    override val titleRes = R.string.goal_detail_title
...
fun GoalDetailsScreen(
    ...
    Scaffold(
        topBar = {
            ...
            FloatingActionButton(
                onClick = { navigateToEditItem(uiState.value.goalDetails.id) },
                ...
                Icon(
                    ...
                    contentDescription = stringResource(R.string.edit_goal_title),
                )
            }
        }, modifier = modifier
    ) { innerPadding ->
